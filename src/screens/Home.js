...
const predictData = [
  {
    ...
    properties:"Cot|Hairdryer|Swimming Pool (Indoor)|Jacuzzi (Hotel)|Flatscreen TV|WiFi (Rooms)|Free WiFi (Public Areas)|Lift|Central Heating|Terrace (Hotel)|Television|Desk|Free WiFi (Combined)|Free WiFi (Rooms)|Non-Smoking Rooms|Safe (Hotel)|Hotel|Hotel Bar|Satellite TV|Balcony|WiFi (Public Areas)"
  },
  {
    id: 96264,
